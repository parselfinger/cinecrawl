...
def generate_signature(body_dict: dict, secret_key: str, timestamp: int) -> str:
    ...
    special_chars = r"[áéíóúüñ¿¡ÁÉÍÓÚÜÑāčēģīķļņšūžĀČĒĢĪĶĻŅŠŪŽ£€ğĞ\u00e1\u00e9\u00ed\u00f3\u00fa\u00fc\u00f1\u00bf\u00a1\u00c1\u00c9\u00cd\u00d3\u00da\u00dc\u00d1\u0101\u010d\u0113\u0123\u012b\u0137\u013c\u0146\u0161\u016b\u017e\u0100\u010c\u0112\u0122\u012a\u0136\u013b\u0145\u0160\u016a\u017d\u00a3\u20ac\u011f\u011e]"  # noqa
...
async def scrape(location: str = "landmark") -> list[Showtime]:
    ...
    cinema_location_id = location_info["cinema_location_id"]
